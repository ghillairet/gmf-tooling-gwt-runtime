 ...
 */
package org.eclipse.gmf.runtime.gwt.edit.parts.update;

import org.eclipse.emf.common.notify.Notification;
import org.eclipse.emf.common.notify.impl.AdapterImpl;
import org.eclipse.emf.ecore.EStructuralFeature;
import org.eclipse.gmf.runtime.gwt.edit.parts.update.IExternallyUpdatableEditPart.ExternalRefresher;
...
public class RefreshAdapter extends AdapterImpl {
	...
	public void notifyChanged(Notification msg) {
		...
		if (myHost instanceof IExternallyUpdatableEditPart) {
			for (ExternalRefresher nextExternalRefresher : ((IExternallyUpdatableEditPart) myHost).getExternalRefreshers()) {
