...
import org.eclipse.gmf.runtime.gwt.requests.SetAllBendpointsRequest;
...
public class BendpointEditPolicy extends org.eclipse.gef.editpolicies.BendpointEditPolicy {
	...
	private Command getModifyBendpointCommand(final BendpointModifier modifier) {
		EditingDomain editingDomain = AdapterFactoryEditingDomain.getEditingDomainFor(getDiagramEdge().getDiagram().getElement());
	...
	private class BendpointModificationCommand extends AbstractCommand {
		...
		protected boolean prepare() {
			EditingDomain domain = AdapterFactoryEditingDomain.getEditingDomainFor(getDiagramEdge());
