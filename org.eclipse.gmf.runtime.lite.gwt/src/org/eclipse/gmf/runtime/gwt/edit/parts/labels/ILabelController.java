...
public interface ILabelController {
	...
	public static class LabelRefresher implements EditPartRefresher {
		private final ILabelController myController;
		private final EObject mySource;

		public LabelRefresher(ILabelController controller, EObject source) {
		...
		public boolean shouldRefresh(Notification notification) {
			...
			return myController.getLabelTextDisplayer().isAffectingEvent(notification);
		}
	}
}
