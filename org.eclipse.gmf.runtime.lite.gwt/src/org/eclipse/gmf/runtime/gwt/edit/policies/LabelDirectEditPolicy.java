 ...
 */
package org.eclipse.gmf.runtime.gwt.edit.policies;
...
public class LabelDirectEditPolicy extends DirectEditPolicy {
	...
	protected Command getDirectEditCommand(DirectEditRequest request) {
		final ILabelTextDisplayer labelTextDisplayer = getTextAwareEditPart().getLabelTextDisplayer();
		if (labelTextDisplayer == null) {
			return UnexecutableCommand.INSTANCE;
		}
		final String value = getCellEditorValue(request);
		if (value == null) {
		...
		EditingDomain domain = AdapterFactoryEditingDomain.getEditingDomainFor(view.getDiagram().getElement());
		return new WrappingCommand(domain, labelTextDisplayer.getApplyCommand(modelElement, value));
	}
