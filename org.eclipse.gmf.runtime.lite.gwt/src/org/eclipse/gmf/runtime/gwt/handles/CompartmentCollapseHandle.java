 ...
 */
package org.eclipse.gmf.runtime.gwt.handles;
...
public class CompartmentCollapseHandle extends CompartmentNameHandle {
	private EditingDomain myDomain;
...
//		NotificationFilter filter = NotificationFilter.createNotifierFilter(ownerView)
//				.and(NotificationFilter.createFeatureFilter(NotationPackage.eINSTANCE.getView_Styles()));
//
//		NotificationFilter childrenFilter = NotificationFilter.createNotifierFilter(ownerView)
//				.and(NotificationFilter.createFeatureFilter(NotationPackage.eINSTANCE.getView_PersistedChildren())
//				.or(NotificationFilter.createFeatureFilter(NotationPackage.eINSTANCE.getView_TransientChildren())));
//
...
//			return PluginImages.get(PluginImages.IMG_HANDLE_EXPAND);
	...
	public void addNotify() {
		super.addNotify();
		View ownerView = getOwnerView();
		myDomain = AdapterFactoryEditingDomain.getEditingDomainFor(ownerView);
	}
