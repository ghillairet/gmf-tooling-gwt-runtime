...
public class CompartmentCollapseTracker extends AbstractTool implements DragTracker {
	...
	private Command createCommand(final DrawerStyle style, final Boolean newValue) {
		final EditingDomain editingDomain = AdapterFactoryEditingDomain.getEditingDomainFor(style);
